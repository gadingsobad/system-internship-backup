    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <ul class="nav nav-pills nav-fill">
                <li class="nav-item">
                    <a <?= $this->uri->segment(1) == 'custom_project_prepared'  ? 'class="nav-link active"' : 'class="nav-link"' ?> href="<?= site_url('custom_project_prepared') ?>">
                        <span class="nav-icon">
                ...
                <li class="nav-item">
                    <a <?= $this->uri->segment(1) == 'custom_project_proccess'  ? 'class="nav-link active bg-primary"' : 'class="nav-link"' ?>class="nav-link" href="<?= site_url('custom_project_proccess') ?>" aria-controls="profile">
                        <span class="nav-icon">
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">On Proccess
                        </h3>
                    </div>
                </div>
                <div class="card-body bg-primary-o-15">
                    <div class="row">
                        <?php
                        foreach ($project_proccess as $value) :;
                        ?>
                            <div class="col-xl-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column mr-auto">
                                                <!--begin: Title-->
                                                <a href="#" class="card-title text-hover-primary font-weight-bolder font-size-h5 text-dark mb-1"><?= $value['project_name'] ?></a>
