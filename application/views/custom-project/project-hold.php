    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <ul class="nav nav-pills nav-fill">
                ...
                <li class="nav-item">
                    <a <?= $this->uri->segment(1) == 'custom_project_hold'  ? 'class="nav-link active bg-danger"' : 'class="nav-link"' ?>class="nav-link" href="<?= site_url('custom_project_hold') ?>" aria-controls="profile">
                        <span class="nav-icon">
                            <i class="flaticon2-layers-1"></i>
                        </span>
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <div class="card-title">
                        <h3 class="card-label">Hold
                        </h3>
                    </div>
                </div>
                <div class="card-body bg-danger-o-15">
                    <div class="row">
                        <?php
                        foreach ($project_hold as $value) :;
                        ?>
                            <div class="col-xl-6">
