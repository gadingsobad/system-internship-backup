...
<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer">
    ...
    <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <a href="https://soloabadi.com/en/" target="_blank" class="text-dark-75 text-hover-primary">Solo Abadi</a>
        </div>
        <!--end::Copyright-->
        <!--begin::Nav-->
        <div class="nav nav-dark">
            <a href="https://soloabadi.com/en/about-us/" target="_blank" class="nav-link pl-0 pr-5">About</a>
            <a href="https://soloabadi.com/en/our-teams/" target="_blank" class="nav-link pl-0 pr-5">Team</a>
            <a href="https://soloabadi.com/en/contact-us/" target="_blank" class="nav-link pl-0 pr-0">Contact</a>
        </div>
        <!--end::Nav-->
    </div>
    <!--end::Container-->
