    ...
    <div id="kt_header" class="header header-fixed">
        ...
        <div class="container-fluid d-flex align-items-stretch justify-content-between">
            ...
            <div class="topbar">
                    ...
                    <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                        <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary">
                            <span class="svg-icon svg-icon-xl svg-icon-primary">
                                <!--begin::Svg Icon | path:<?= base_url('assets/'); ?>media/svg/icons/Code/Compiling.svg-->
                ...
                <!--begin::User-->
                <div class="topbar-item">
                    <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-8" id="kt_quick_user_toggle" style="background-color: #639AEF; color:white;">
                        <span class="text-light font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                        <span class="text-light-50 font-weight-bolder font-size-base d-none d-md-inline mr-15"><?= ($data_user['name']) ?></span>
                        <span class="symbol symbol-lg-35 symbol-25 symbol-light-secondary">
