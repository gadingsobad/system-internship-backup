        ...
        <div class="container-3">
            ...
            <table class="tbl-image">
                <tr>
                    ...
                    <td class="row">
                        <?php if ($index['foto2'] !== '') { ?>
                            <img class="img-kegiatan" src="<?= base_url('assets/foto/' . $index['foto2']); ?>">
                        <?php } else {
                        } ?>
                    </td>
                </tr>
            ...
            <table class="tbl-image">
                <tr>
                    <td class="row">
                        <?php if ($index['foto3'] !== '') { ?>
                            <img class="img-kegiatan" src="<?= base_url('assets/foto/' . $index['foto3']); ?>">
                        <?php } else {
                        } ?>
                    </td>
                    <td class="row">
                        <?php if ($index['foto4'] !== '') { ?>
                            <img class="img-kegiatan" src="<?= base_url('assets/foto/' . $index['foto4']); ?>">
                        <?php } else {
                        } ?>
                    </td>
                </tr>
